...
function Footer() {
  return (
    <div className='mobile:flex-center flex w-full max-w-[120rem] flex-col  items-center pt-100 text-14 tablet:flex-row tablet:justify-between tablet:px-40 tablet:text-18 '>
      <div>©codeit - 2023</div>
